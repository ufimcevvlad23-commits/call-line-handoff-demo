  ...
  return new Promise((resolve, reject) => {
    ...
    socket.on("connect", () => {
      ...
      socket.write(encodeAction({
        ...
        Priority: 1,
        // The manager leg must identify the client in Bitrix, not the corporate
        // Beeline line. CB_CALLER_ID remains separate for the customer leg.
        CallerID: safeClientPhone,
